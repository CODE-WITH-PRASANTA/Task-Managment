...
const Vip6display = () => {
  ...
  useEffect(() => {
    const fetchTasks = async () => {
      try {
        const response = await axios.get(`${config.baseUrl}api/vip6`); // Use the base URL from config.js
  ...
  return (
    <div className="Vip6-display">
      <h2>Vip-6 Tasks</h2>
      <p className="intro-text">
        Welcome to Vip-6! You've successfully accessed this section. Complete the tasks below to earn rewards directly in your wallet. Follow the rules for smooth task completion.
      </p>
