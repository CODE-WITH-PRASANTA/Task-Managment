...
const Vip3display = () => {
  ...
  useEffect(() => {
    const fetchTasks = async () => {
      try {
        const response = await axios.get(`${config.baseUrl}api/vip3`); // Use the base URL from config.js
  ...
  return (
    <div className="Vip3-display">
      <h2>Vip-3 Tasks</h2>
      <p className="intro-text">
        Welcome to Vip-3! You've successfully accessed this section. Complete the tasks below to earn rewards directly in your wallet. Follow the rules for smooth task completion.
      </p>
