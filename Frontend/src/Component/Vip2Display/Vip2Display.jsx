...
const Vip2display = () => {
  ...
  useEffect(() => {
    const fetchTasks = async () => {
      try {
        const response = await axios.get(`${config.baseUrl}api/vip2`); // Use the base URL from config
  ...
  return (
    <div className="Vip2-display">
      <h2>Vip-2 Tasks</h2>
      <p className="intro-text">
        Welcome to Vip-2! You've successfully accessed this section. Complete the tasks below to earn rewards directly in your wallet. Follow the rules for smooth task completion.
      </p>
